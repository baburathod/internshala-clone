...
- Name: verification.spec.ts >> End-to-End Visual Verification Suite >> Community - Post Rendering & Action UIs
- Location: e2e\verification.spec.ts:31:7
...
Locator: locator('text=Friends').first()
Expected: visible
Timeout: 10000ms
...
Call log:
  ...
  - waiting for locator('text=Friends').first()
...
- dialog "Recoverable Error":
  ...
  - button "complete Component Stack":
    - img
  - code: "... <App pageProps={{}} Component={function Community} err={undefined} router={{sdc:{},sbc:{}, ...}}> <Provider store={{...}}> <AuthListener> <div className=\"bg-white\"> <Lt> <Navbar> <div className=\"relative z-50\"> <nav className=\"bg-white s...\"> <div className=\"max-w-7xl ...\"> <div className=\"flex justi...\"> <div> <div> <div className=\"hidden md:...\"> <div className=\"relative\"> <button onClick={function onClick} className=\"flex items...\"> <Globe> <span className=\"uppercase\"> + en-US - en-IN ... ... ... ..."
