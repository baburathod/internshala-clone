...
const Page = () => {
  return (
    <div className="min-h-screen bg-gray-50 flex flex-col font-sans">
      <Head>
        <title>Internships in San Francisco - Internshala Clone</title>
        <meta name="description" content="Silicon Valley tech internships and startup roles." />
      </Head>

      {/* Hero Section */}
      <div className="bg-blue-600 text-white py-20 px-4 text-center">
        <h1 className="text-4xl font-extrabold mb-4">Internships in San Francisco</h1>
        <p className="text-xl max-w-2xl mx-auto">Silicon Valley tech internships and startup roles.</p>
      </div>

      {/* Breadcrumbs */}
      <div className="max-w-7xl mx-auto w-full px-4 py-4 text-sm text-gray-500">
        Home {'>'} Footer {'>'} <span className="font-semibold text-gray-800">Internships in San Francisco</span>
      </div>
      ...
      <div className="flex-grow max-w-7xl mx-auto w-full px-4 py-12">
        <div className="bg-white rounded-xl shadow p-8 text-gray-800 leading-relaxed">
          ...
          <p className="mb-8">Silicon Valley tech internships and startup roles.</p>
          ...
          <ul className="list-disc pl-5 space-y-2 mb-8">
            <li>Software Engineering</li><li>Product Management</li><li>Design</li>
          </ul>
