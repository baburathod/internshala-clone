...
const index = () => {
  ...
  const handlesubmit = async (e: React.FormEvent) => {
    ...
    try {
      setisloading(true);
      const res = await axios.post((process.env.NEXT_PUBLIC_API_URL || "http://localhost:5000") + "/api/internship", formData);
            ...
            <div className="space-y-4">
              <div>
                ...
                <textarea
                  ...
                  onChange={handleChange}
                  rows={4}
                  className="text-black mt-1 block w-full resize-y rounded-md border border-gray-300 px-3 py-2 focus:border-blue-500 focus:ring-blue-500 sm:text-sm"
