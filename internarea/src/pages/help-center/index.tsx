...
export default function helpcenterPage() {
  return (
    <div className="bg-gray-50 flex flex-col">
      <Head>
        <title>Help Center | Intern Area - Real World Internships</title>
        <meta name="description" content="Find answers to common questions quickly.. Find out more about our mission, hiring, and salaries." />
        <meta name="keywords" content="Help Center, jobs, internships, careers, Intern Area" />
      </Head>
      ...
      <main className="flex-grow">
        ...
        <section className="bg-blue-600 text-white py-20">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            <h1 className="text-4xl md:text-5xl font-extrabold mb-4">{t("Help Center") || "Help Center"}</h1>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
            <div>
              ...
              <p className="text-gray-700 text-lg mb-4">
                At Intern Area, our mission is to build the ultimate bridge between ambitious talent and industry-leading organizations. Find answers to common questions quickly. We believe in creating transparent, scalable, and equitable hiring ecosystems.
              </p>
            ...
            <div className="bg-white p-8 rounded-xl shadow-sm border border-gray-100">
              ...
              <div className="mb-6">
                ...
                <p className="text-gray-600">Support engineers wanted.</p>
              </div>
              <div className="mb-6">
