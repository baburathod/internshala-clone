        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="mt-16 max-w-4xl mx-auto">
            <h3 className="text-2xl font-bold text-gray-900 mb-6 flex items-center">
              <Shield className="mr-2 text-blue-600" /> Subscription History & Invoices
            </h3>
            <div className="bg-white shadow overflow-hidden sm:rounded-lg border border-gray-200">
              <table className="min-w-full divide-y divide-gray-200">
                ...
                <tbody className="bg-white divide-y divide-gray-200">
                  {currentPlan !== 'Free' ? (
                    <tr>
                      <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-900">{new Date().toLocaleDateString()}</td>
                      <td className="px-6 py-4 whitespace-nowrap text-sm font-semibold text-gray-900">{currentPlan}</td>
                      <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-500">₹{plans.find(p => p.name === currentPlan)?.price || 0}</td>
                      ...
                      <td className="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                        <button className="text-blue-600 hover:text-blue-900">Download PDF</button>
                      </td>
                    </tr>
                  ) : (
                    <tr>
                      <td colSpan={5} className="px-6 py-4 text-center text-sm text-gray-500 italic">No paid subscriptions found.</td>
                    </tr>
                  )}
                </tbody>
              </table>
