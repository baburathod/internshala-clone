...
export default function privacypolicyPage() {
  return (
    <div className="bg-gray-50 flex flex-col">
      <Head>
        <title>Privacy Policy | Intern Area - Real World Internships</title>
        <meta name="description" content="How we protect and handle your personal data.. Find out more about our mission, hiring, and salaries." />
        <meta name="keywords" content="Privacy Policy, jobs, internships, careers, Intern Area" />
      </Head>
      ...
      <main className="flex-grow">
        ...
        <section className="bg-blue-600 text-white py-20">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            <h1 className="text-4xl md:text-5xl font-extrabold mb-4">{t("Privacy Policy") || "Privacy Policy"}</h1>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
            <div>
              ...
              <p className="text-gray-700 text-lg mb-4">
                At Intern Area, our mission is to build the ultimate bridge between ambitious talent and industry-leading organizations. How we protect and handle your personal data. We believe in creating transparent, scalable, and equitable hiring ecosystems.
              </p>
            ...
            <div className="bg-white p-8 rounded-xl shadow-sm border border-gray-100">
              ...
              <div className="mb-6">
                ...
                <p className="text-gray-600">Data privacy officers wanted.</p>
              </div>
              <div className="mb-6">
                <p className="font-semibold text-gray-800">Compensation & Salary:</p>
                <p className="text-gray-600">$140k - $180k annually. Equity, health benefits, and 401(k) matching included.</p>
              </div>
          ...
          <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div className="space-y-6">
              ...
              <div className="bg-gray-50 p-6 rounded-lg">
                ...
                <p className="text-gray-600">Yes, we enforce strict transparency rules. The compensation listed ($140k - $180k annually.) is fully verified.</p>
              </div>
            </div>
          </div>
        </section>
