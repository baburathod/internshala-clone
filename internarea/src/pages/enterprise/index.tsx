...
const Page = () => {
  return (
    <div className="min-h-screen bg-gray-50 flex flex-col font-sans">
      <Head>
        <title>Enterprise Solutions - Internshala Clone</title>
        <meta name="description" content="Analytics, Dedicated Support, and Bulk Hiring." />
      </Head>

      {/* Hero Section */}
      <div className="bg-blue-600 text-white py-20 px-4 text-center">
        <h1 className="text-4xl font-extrabold mb-4">Enterprise Solutions</h1>
        <p className="text-xl max-w-2xl mx-auto">Analytics, Dedicated Support, and Bulk Hiring.</p>
      </div>

      {/* Breadcrumbs */}
      <div className="max-w-7xl mx-auto w-full px-4 py-4 text-sm text-gray-500">
        Home {'>'} Footer {'>'} <span className="font-semibold text-gray-800">Enterprise Solutions</span>
      </div>
      ...
      <div className="flex-grow max-w-7xl mx-auto w-full px-4 py-12">
        <div className="bg-white rounded-xl shadow p-8 text-gray-800 leading-relaxed">
          ...
          <p className="mb-8">Analytics, Dedicated Support, and Bulk Hiring.</p>
          
          <h2 className="text-2xl font-bold mb-6 text-gray-900 border-b pb-2">Details</h2>
          <p className="mb-6 font-medium text-lg">Trusted by Fortune 500 companies.</p>
