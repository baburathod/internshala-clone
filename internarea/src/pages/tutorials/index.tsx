...
export default function tutorialsPage() {
  return (
    <div className="min-h-screen bg-gray-50 flex flex-col">
      <Head>
        <title>Tutorials | Intern Area - Real World Internships</title>
        <meta name="description" content="Learn how to maximize your chances of getting hired.. Find out more about our mission, hiring, and salaries." />
        <meta name="keywords" content="Tutorials, jobs, internships, careers, Intern Area" />
      </Head>
      ...
      <main className="flex-grow">
        ...
        <section className="bg-blue-600 text-white py-20">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            <h1 className="text-4xl md:text-5xl font-extrabold mb-4">{t("Tutorials") || "Tutorials"}</h1>
            <p className="text-xl md:text-2xl font-light text-blue-100 max-w-3xl mx-auto">
              Learn how to maximize your chances of getting hired.
            </p>
          </div>
        </section>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
            <div>
              ...
              <p className="text-gray-700 text-lg mb-4">
                At Intern Area, our mission is to build the ultimate bridge between ambitious talent and industry-leading organizations. Learn how to maximize your chances of getting hired. We believe in creating transparent, scalable, and equitable hiring ecosystems.
              </p>
            ...
            <div className="bg-white p-8 rounded-xl shadow-sm border border-gray-100">
              ...
              <div className="mb-6">
                ...
                <p className="text-gray-600">Instructional designers wanted.</p>
              </div>
              <div className="mb-6">
                <p className="font-semibold text-gray-800">Compensation & Salary:</p>
                <p className="text-gray-600">$80k - $110k annually. Equity, health benefits, and 401(k) matching included.</p>
              </div>
          ...
          <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div className="space-y-6">
              ...
              <div className="bg-gray-50 p-6 rounded-lg">
                ...
                <p className="text-gray-600">Yes, we enforce strict transparency rules. The compensation listed ($80k - $110k annually.) is fully verified.</p>
              </div>
            </div>
          </div>
        </section>
