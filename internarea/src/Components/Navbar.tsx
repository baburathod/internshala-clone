              ...
              <div className="px-3 py-2">
                {isLoading ? (
                  ...
                  <div className="flex flex-col space-y-2">
                    ...
                    <button
                      className="flex items-center w-full px-3 py-2 text-left text-base font-medium text-gray-700 hover:bg-gray-50 rounded-md"
                      onClick={handlelogout}
                    >
                      Logout
                    </button>
                  ...
                  <div className="flex flex-col space-y-2">
                    ...
                    <a
                      href="/adminlogin"
                      className="block px-3 py-2 text-center rounded-md text-base font-medium text-gray-600 hover:text-gray-800 hover:bg-gray-50"
                    >
                      Admin
                    </a>
                  </div>
